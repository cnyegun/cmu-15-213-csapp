...
#ifdef HAS_GUI
/* Forward declaration for Tcl_AppInit */
		...
		int argc, char *argv[])
{
    ...
    Tcl_SetResult(interp, (char *) stat_name(STAT_AOK), TCL_VOLATILE);
    return TCL_OK;
}
	      ...
	      int argc, char *argv[])
{
    ...
    Tcl_SetResult(interp, (char *) stat_name(run_status), TCL_VOLATILE);
    return TCL_OK;
}
